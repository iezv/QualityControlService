...
public class QualityOrmCreation implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		// ---------------------------------------
		Employee ceo = new Employee(100000001, "Ivan", 1975, "555-55-55", "ceo@mail.ru", genRandomAddress());
	...
	// Add COMPANY
	private void createCompany(Company company, Employee ceo, QualityOrm qualityOrm) {
